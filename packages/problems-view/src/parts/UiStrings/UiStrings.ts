...
export const ShowErrors = 'Show Errors'
export const ShowWarnings = 'Show Warnings'
export const ShowInfos = 'Show Infos'
export const ProblemsTree = 'Problems Tree'
export const MoreFilters = 'more filters'
